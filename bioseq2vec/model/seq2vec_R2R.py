...
from bioseq2vec.transformer import HashIndexTransformer
from bioseq2vec.transformer import OneHotEncodedTransformer
from bioseq2vec.model import TrainableSeq2VecBase


class Seq2VecR2R(TrainableSeq2VecBase):
    """
    ...
    def __init__(
        ...
        super(Seq2VecR2R, self).__init__(
            max_length,
            latent_size,
            learning_rate
        )
